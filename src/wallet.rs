...
pub(crate) struct Wallet {
  bitcoin_client: peercoin_rpc::Client,
  has_rune_index: bool,
  has_sat_index: bool,
  rpc_url: Url,
...
impl Wallet {
  ...
  fn get_utxos(bitcoin_client: &peercoin_rpc::Client) -> Result<BTreeMap<OutPoint, TxOut>> {
    Ok(
      bitcoin_client
  ...
  pub(crate) fn bitcoin_client(&self) -> &peercoin_rpc::Client {
    &self.bitcoin_client
  }
